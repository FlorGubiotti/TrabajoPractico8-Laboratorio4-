package com.example.TrabajoPractico8;
...
public class TrabajoPractico8Application {

	private static final Logger logger = LoggerFactory.getLogger(TrabajoPractico8Application.class);

	public static void main(String[] args) {
		SpringApplication.run(TrabajoPractico8Application.class, args);
	}
